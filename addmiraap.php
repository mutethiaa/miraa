...
<html class="no-js">
              ...
              <nav class="collapse navbar-collapse" id="navbar">
                  <ul class="nav navbar-nav navbar-right" id="top-nav">
                      ...
                      <li><a href="#contact">Contact</a></li>
                         <li class="current"><a href="addmiraap.php">sell</a></li>
   ...
   <div class="col-xs-12 col-sm-12 col-md-5 col-md-offset-1 wow fadeInUp" data-wow-delay="0.3s">
    ...
    <p>enter details of miraa</p>
  
  
  <form method="post" action="addmiraa.php" enctype="multipart/form-data">
  
    <div class="input-group">
      <label>category</label><br>
      <input type="text" name="category" value="<?php echo $username; ?>">
    </div>
    <div class="input-group">
      <label>description</label><br>
      <input type="text" name="description" value="<?php echo $username; ?>">
    </div>
    <div class="input-group">
  ...
  <br>
  <div class="input-group">
    <label>miraa picture</label>
<input type="file" name="uploadfile" value="default img.png" accept="image/png,.jpeg,.jpg,.image/gif" placeholder="image">


      <button type="submit" id="btn" name="reg_user">upload</button>
    </div>
<p>
      Already a member? <a href="index.php">exit</a>
    </p>
  </form>
...
$sql = "INSERT INTO message (username, email,meso,phone )
