	                ...
	                <ul class="nav navbar-nav navbar-right" id="top-nav">
                      ...
                      <li><a href="#learn">learn</a></li>
	                    ...
	                    <li><a href="#contact">Contact</a></li>
                         <li><a href="addmiraap.php">sell</a></li>
...
$conn=mysqli_connect("localhost","root","","miraa");
...
?>
<?php
    echo " <img src='images/". $row['image']. " ' class='img-responsive' id='picsmiraa'>

    ";
    ?>
    <?php
    echo "bei :" . $row["price"]. "<br>";?>
    <?php
    echo "kiasi:" . $row["quantity"]. "<br>";?>
    <a href="order.php ?id=<?php
    echo $row["id"];?>"><button>agiza</button></a>
    <a href="order.php?id=<?php echo $row["id"]; ?>"id="mi">Delete</a>
